						...
						<div class="detail">
							<div class="inner-wrapper">
								<form method="post">
									...
									<div>
										<input type="text" name="r_content" placeholder="한줄평을 입력해주세요."/>
										<span>*필수</span>
									</div>
									<div>
										<select name="r_score">
									...
									<div>
										<input type="hidden" name="cmd" value="insert_review">
										<input type="button" value="리뷰 작성" onclick="insert_review(this.form)" />
									</div>
								</form>
							</div>
						</div>
